class Admin::WorkTypesController < Admin::AdminApplicationController  
  ...
  def destroy
    @work_type.destroy
    respond_to do |format|
      format.html { redirect_to admin_work_types_url, notice: 'Work type was successfully destroyed.' }
